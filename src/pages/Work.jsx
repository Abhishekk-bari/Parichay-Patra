      ...
      <div className="bg-[#121212] w-[90vw] ml-20 h-[70vw] p-10 rounded-3xl">
        ...
        <div className="Project-container mt-20 flex flex-col space-y-20">
          ...
          <div className="flex items-start text-white pb-10">
            ...
            <div className="ml-5">
              <h1 className="font-['NeueMontrealRegular'] text-2xl">Bookifi | Full stack</h1>
              <p className="mt-2">Tech Stack:</p>
              <div className="flex space-x-4 mt-2">
              ...
              <p className="mt-4 text-lg">Designed a feature-rich booking platform for photographers, integrating React, Node.js, Express, and MongoDB for secure data handling and management and animations using GSAP. Developed a custom admin panel with secure login/logout functionality, enabling photographers to monitor booking sessions and communicate with clients directly  </p>
            </div>
          </div>
          ...
          <div className="flex items-start text-white">
            <div className="mr-5">
              ...
              <p className="mt-4 mr-70 ">Design website that gives Interactive User Experience fully animated and interactive and add some spice using javascript, landing page equipped with smooth animations and responsive design.</p>
            </div>
            <a href="https://thirty-six-studio-eight.vercel.app/" target="_blank" rel="noopener noreferrer">
              <video
                src={card3} 
                className="w-[100vw] h-[20vw] ml-4" 
                controls
